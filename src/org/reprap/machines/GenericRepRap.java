...
public abstract class GenericRepRap implements Printer {
    ...
    public Extruder extruderFactory(final int count) {
    ...
    public void refreshPreferences() {
        try {
            //load axis prefs
            final int axes = 3;//Preferences.loadGlobalInt("AxisCount");
            //if (axes != 3)
        ...
        for (final Extruder extruder2 : extruders) {
    ...
    /**
     * Despite its name, this gets called at the end... That's because the
     * layers are computed top to bottom.
     */
     ...
     */
    public Extruder getExtruder(final String name) {
        for (final Extruder extruder2 : extruders) {
     ...
     */
    public void moveTo(final double x, final double y, final double z, final double feedRate, final boolean startUp,
            final boolean endUp) throws RepRapException, IOException, Exception {
        if (isCancelled()) {
            return;
        }
    ...
    public void singleMove(final double x, final double y, final double z, final double feedrate, final boolean really) {
        try {
    ...
    public void homeToZeroXYE(final boolean really) throws RepRapException, IOException, Exception {
    }
    ...
    public void setTopDown(final boolean td) {
        topDown = td;
    }
