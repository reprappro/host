...
java -Djava.library.path=.\system-dependent\windows\w32;%PATH% -cp "./reprap.jar;./j3d-org-java3d-all.jar;./j3dutils.jar;./vecmath.jar;./j3dcore.jar; ./swing-layout-1.0.4.jar;.;"%CLASSPATH% -Xmx%REPRAP_RAM_SIZE% org/reprap/Main
