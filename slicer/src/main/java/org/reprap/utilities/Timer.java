...
public class Timer {
    ...
    /**
     * Constructor just needs to create a single instance for
     * initialiseIfNeedBe(String e)
     * 
     */
    private Timer() {
    }
     ...
     * @return
     */
    static private String d3dp(final double v) {
